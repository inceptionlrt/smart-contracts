...
/*  {
    ...
    assetPool: "0x64f2907F92631619ED7Ea510982835F9e1024767",
    vaultName: "IncbEthVault",
    vaultFactory: "InVault_E1",
    strategyManager: "0x858646372CC42E1A627fcE94aa7A7033e7CF075A",
    assetStrategy: "0x54945180db7943c0ed0fee7edab2bd24620256bc",
  ...
  },
  {
    ...
    vaultFactory: "InVault_E1",
    strategyManager: "0x858646372CC42E1A627fcE94aa7A7033e7CF075A",
    assetStrategy: "0x8CA7A5d6f3acd3A7A8bC468a8CD0FB14B6BD28b6",
    iVaultOperator: "0xa4341b5Cf43afD2993e1ae47d956F44A2d6Fc08D",
    withdrawalDelayBlocks: 10,
    ratioErr: 2n,
    transactErr: 2n,
  ...
  },
  {
    ...
    vaultFactory: "InVault_E1",
    strategyManager: "0x858646372CC42E1A627fcE94aa7A7033e7CF075A",
    assetStrategy: "0x298aFB19A105D59E74658C4C334Ff360BadE6dd2",
    iVaultOperator: "0xa4341b5Cf43afD2993e1ae47d956F44A2d6Fc08D",
    withdrawalDelayBlocks: 10,
    ratioErr: 2n,
    transactErr: 2n,
  ...
  },
  {
    ...
    vaultFactory: "InVault_E1",
    strategyManager: "0x858646372CC42E1A627fcE94aa7A7033e7CF075A",
    assetStrategy: "0x9d7eD45EE2E8FC5482fa2428f15C971e6369011d",
    iVaultOperator: "0xa4341b5Cf43afD2993e1ae47d956F44A2d6Fc08D",
    withdrawalDelayBlocks: 10,
    ratioErr: 2n,
    transactErr: 2n,
  ...
  },
  {
    ...
    vaultFactory: "InVault_E1",
    strategyManager: "0x858646372CC42E1A627fcE94aa7A7033e7CF075A",
    assetStrategy: "0x0fe4f44bee93503346a3ac9ee5a26b130a5796d6",
    iVaultOperator: "0xa4341b5Cf43afD2993e1ae47d956F44A2d6Fc08D",
    withdrawalDelayBlocks: 10,
    ratioErr: 2n,
    transactErr: 2n,
  ...
  },
  {
    ...
    assetPool: "0x39254033945AA2E4809Cc2977E7087BEE48bd7Ab",
    vaultName: "InoEthVault",
    vaultFactory: "InVault_E1",
    strategyManager: "0x858646372CC42E1A627fcE94aa7A7033e7CF075A",
    assetStrategy: "0xa4c637e0f704745d182e4d38cab7e7485321d059",
    iVaultOperator: "0xa4341b5Cf43afD2993e1ae47d956F44A2d6Fc08D",
    withdrawalDelayBlocks: 10,
    ratioErr: 2n,
    transactErr: 2n,
  ...
  },
  {
    ...
    assetPoolName: "WBEth",
    assetPool: "0xa2e3356610840701bdf5611a53974510ae27e2e1",
    vaultName: "InwbEthVault",
    vaultFactory: "InVault_E1",
    strategyManager: "0x858646372CC42E1A627fcE94aa7A7033e7CF075A",
    assetStrategy: "0x7CA911E83dabf90C90dD3De5411a10F1A6112184",
    iVaultOperator: "0xa4341b5Cf43afD2993e1ae47d956F44A2d6Fc08D",
    withdrawalDelayBlocks: 10,
    ratioErr: 2n,
    transactErr: 2n,
  ...
  },
  {
    ...
    vaultFactory: "InVault_E1",
    strategyManager: "0x858646372CC42E1A627fcE94aa7A7033e7CF075A",
    assetStrategy: "0x57ba429517c3473b6d34ca9acd56c0e735b94c02",
    iVaultOperator: "0xa4341b5Cf43afD2993e1ae47d956F44A2d6Fc08D",
    withdrawalDelayBlocks: 10,
    ratioErr: 2n,
    transactErr: 2n,
  ...
  },
  {
    ...
    assetPool: "0x84db6ee82b7cf3b47e8f19270abde5718b936670",
    vaultName: "InankrEthVault",
    vaultFactory: "InVault_E1",
    strategyManager: "0x858646372CC42E1A627fcE94aa7A7033e7CF075A",
    assetStrategy: "0x13760f50a9d7377e4f20cb8cf9e4c26586c658ff",
    iVaultOperator: "0xa4341b5Cf43afD2993e1ae47d956F44A2d6Fc08D",
    withdrawalDelayBlocks: 10,
    ratioErr: 1n,
    transactErr: 2n,
  ...
  },
  {
    ...
    vaultFactory: "InVault_E1",
    strategyManager: "0x858646372CC42E1A627fcE94aa7A7033e7CF075A",
    assetStrategy: "0xAe60d8180437b5C34bB956822ac2710972584473",
    iVaultOperator: "0xa4341b5Cf43afD2993e1ae47d956F44A2d6Fc08D",
    withdrawalDelayBlocks: 10,
    ratioErr: 2n,
    transactErr: 2n,
...
const initVault = async (a) => {
  ...
  return [iToken, iVault, asset, assetPool, strategy, iVaultOperator];
};

assets.forEach(function(a) {
  describe("Inception pool V4 rEth", function () {
    this.timeout(150000);
    let iToken, iVault, asset, assetPool, strategy;
    ...
    before(async function () {
      ...
      [iToken, iVault, asset, assetPool, strategy, iVaultOperator] = await initVault(a);
      ratioErr = a.ratioErr;
    ...
    describe("deposit: user can restake asset", function () {
      ...
      args.forEach(function (arg) {
        ...
        it("Delegate all", async function () {
          ...
          const amount = await iVault.totalAssets();
          const tx = await iVault.connect(iVaultOperator).delegateToOperator(amount, nodeOperators[0], ethers.ZeroHash, [ethers.ZeroHash, 0]);
          const receipt = await tx.wait();
      ...
      args4.forEach(function (arg) {
        it(`Delegate many times ${arg.name}`, async function () {
          ...
          for (let i = 0; i < arg.count; i++) {
            ...
            const tx = await iVault.connect(iVaultOperator).delegateToOperator(amount, stakerOperator, ethers.ZeroHash, [ethers.ZeroHash, 0]);
            const receipt = await tx.wait();
    ...
    describe("redeem: withdraw can be retrieved from iVault", function () {
      ...
      it("Stakers deposit", async function () {
        ...
        await iVault.connect(staker2).deposit(staker2Amount, staker2.address);
        await iVault.connect(iVaultOperator).delegateToOperator(await iVault.totalAssets(), nodeOperators[0], ethers.ZeroHash, [ethers.ZeroHash, 0]);
      ...
      it("Reverts: when staker2 redeems out of turn", async function () {
        await expect(iVault.connect(iVaultOperator).redeem(staker2.address)).to.be.revertedWith("InceptionVault: redeem can not be proceed");
      });
