async function main2() {
    ...
    */
    ...
    const sharesSupply = 989995800614486342517n; // value extracted from genesis-staking-service logs
    const l2Supply = 0n; // currently L2 is synced with L1, means there is no "last deposit" unaccounted
    const pendingBalance = 985214216742071116729n; // value extracted from RestakingPool.getPending() - 0xEAA6d9f33c7095218Ed9cD4f0D7FB6551A14005f
    const totalStaked = 32000000000000000000n; // value extracted from genesis-staking-service logs
    const iovBalance = 10000000000n; // value extracted from InceptionOmniVault at address 0x55ec970B8629E01d26BAA7b5d092DD26784136bb
