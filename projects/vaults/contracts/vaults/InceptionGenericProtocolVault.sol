...
import "../eigenlayer-handler/GenericProtocolHandler.sol";

/// @author The InceptionLRT team
/// @title The InceptionVault contract
/// @notice Aims to maximize the profit of EigenLayer for a certain asset.
contract InceptionVault is IInceptionVault, GenericProtocolHandler {
    ...
    function __InceptionVault_init(
        ...
        __Ownable_init();
        __GenericProtocolHandler_init(_strategyManager, _assetStrategy, _mellowDepositWrapper, _mellowVault);
