...
/// @title The GenericProtocolHandler contract
/// @dev Serves communication with external EigenLayer and Mellow protocols
/// @dev Specifically, this includes depositing, and handling withdrawal requests
contract GenericProtocolHandler is InceptionAssetsHandler, IEigenLayerHandler, IMellowHandler {
    ...
    uint256 redeemMellowReservedAmount;
    ...
    function __GenericProtocolHandler_init(
    ...
    function depositMellow(
        ...
        _asset.approve(address(mellowDepositWrapper), amount);
    ...
    function claimMellowWithdrawal(uint256 amount) external onlyOperator {
        redeemMellowReservedAmount += amount;
    }
    ...
    function getFlashCapacity() public view returns (uint256 total) {
        return totalAssets() - redeemReservedAmount - redeemMellowReservedAmount - depositBonusAmount;
    }
