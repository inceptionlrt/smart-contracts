...
export const assetDataNew = {
  ...
  vault: {
    ...
    // inceptionTokenAddress: looks like not required for testrun
    // ratioFeedAddress: looks like not required for testrun
    operator: '0xd87D15b80445EC4251e33dBe0668C335624e54b7', // iVaultOperator
  },

  asset: {
    name: "stETH", // assetName
    address: "0x7f39C581F595B53c5cb19bD0b3f8dA6c935E2Ca0", // assetAddress
    // poolName: "LidoMockPool", // assetPoolName
    // pool: "0x3F1c547b21f65e10480dE3ad8E19fAAC46C95034", // assetPool
