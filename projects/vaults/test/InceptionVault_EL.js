...
const initVault = async (a) => {
  ...
  return [iToken, iVault, ratioFeed, asset, strategy, iVaultOperator, restakerImp, delegationManager, iLibrary];
};

assets.forEach(function (a) {
  describe(`Inception EigenLayer Vault ${a.assetName}`, function () {
    this.timeout(150000);
    let iToken, iVault, ratioFeed, asset, strategy, restakerImp, delegationManager, iLibrary;
    ...
    before(async function () {
      ...
      [iToken, iVault, ratioFeed, asset, strategy, iVaultOperator, restakerImp, delegationManager, iLibrary] = await initVault(a);
      ratioErr = a.ratioErr;
