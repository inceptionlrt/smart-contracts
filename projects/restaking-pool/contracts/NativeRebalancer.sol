    ...
    INativeRebalancer
{
    ...
    L2State public consolidatedl2State;
    ...
    function updateTreasuryData() public {
        ...
        uint256 totalL2InETH = consolidatedl2State.tokenBalance;
    ...
    function handleL2State(
        ...
        require(
            ...
            InvalidTimestamp(consolidatedl2State.timestamp, _timestamp)
        );

        //TODO: add safeguard delta timestamp if needed

        consolidatedl2State = L2State({
            tokenBalance: _tokenBalance,
            ethBalance: _ethBalance,
            timestamp: _timestamp
        });

        emit L2StateUpdated(_tokenBalance, _ethBalance, _timestamp);
    }
