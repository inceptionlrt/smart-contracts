...
interface ICrossChainAdapterL2 {
    ...
    event L1TargetChanged(address indexed prevL1Target, address indexed newL1Target);
    ...
    function sendEthToL1(uint256 _callValue, bytes[] calldata _gasData) external payable returns (bool success);
