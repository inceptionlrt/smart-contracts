...
describe('===FORK===', function () {
    ...
    describe('MetaLRT', function () {
        ...
        it('addStrategy(), setAllocations()', async function () {
            ...
            // Strategy 1
            let YieldStrategy = await ethers.getContractFactory("StrategyYield");
            ...
            // Strategy 2
            ys = await YieldStrategy.deploy(await mLRT.getAddress(), await wstETH.getAddress(), inswETH, inswETHDerivative, await stETH.getAddress(), await ra.getAddress()); await ys.waitForDeployment();
